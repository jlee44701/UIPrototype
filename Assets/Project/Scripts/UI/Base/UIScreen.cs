        ...
        public abstract class UIScreen {
            ...
            public virtual void Initialize() {
                ...
                m_EventRegistry.RegisterCallback<TransitionEndEvent>(
                    m_RootElement, ParentElement_TransitionEnd);
            }
            ...
            private void ParentElement_TransitionEnd(TransitionEndEvent evt) {
                if (evt.target == m_RootElement
                    && m_RootElement.ClassListContains(k_HiddenClass)) {
                    HideImmediately();
                }
            }
            ...
            public virtual void Show() {
                ...
                m_DisplayRoutine =
                    Coroutines.StartCoroutine(ShowWithDelay(m_TransitionDelay));
            }
            ...
            private IEnumerator ShowWithDelay(float delayInSecs) {
                ...
                if (m_UseTransition) {
                    m_RootElement
                        .AddToClassList(k_VisibleClass); // Add visible class
                    m_RootElement.BringToFront();
                    m_RootElement
                        .RemoveFromClassList(
                            k_HiddenClass); // Remove hidden class
                }
            }
            ...
            public virtual void Hide(float delay = 0f) {
                ...
                m_DisplayRoutine =
                    Coroutines.StartCoroutine(HideWithDelay(delay));
            }
            ...
            private IEnumerator HideWithDelay(float delayInSecs) {
                ...
                if (m_UseTransition) {
                    m_RootElement
                        .AddToClassList(k_HiddenClass); // Add hidden class
                    m_RootElement
                        .RemoveFromClassList(
                            k_VisibleClass); // Remove visible class
                }
                else {
                    HideImmediately();
                }
